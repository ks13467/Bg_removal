  ...
  return (
    <div  className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500'>Effortlessly remove backgrounds from your images in seconds. <br className='max-sm:hidden'/>Upload, edit, and download with ease—no design skills needed!</p>
            <div>
